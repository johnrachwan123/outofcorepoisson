/***************************************************************************************************
 * File:         $URL: https://svn.bolitho.us/Library/Trunk/Src/Utility/ElementDecl.hpp $
...
namespace Bolitho
{
  ...
  { enum { NONE = 0x0001, BYTE = 0x1001, SHORT = 0x1002, USHORT = 0x2002, INT = 0x1004, UINT = 0x2004, LONG = 0x1008, ULONG = 0x2008, FLOAT = 0x3004, DOUBLE = 0x3008 }; };
  ...
  public:
    ...
    String GetFullTypeString() CONST;
