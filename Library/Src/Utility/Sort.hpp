/***************************************************************************************************
 * File:         $URL: https://svn.bolitho.us/Library/Trunk/Src/Utility/Sort.hpp $
 * Author:       $Author: matthew $
 * Revision:     $Rev: 1719 $
 * Last Updated: $Date: 2008-12-11 07:41:25 -0800 (Thu, 11 Dec 2008) $
 * 
 * 
...
namespace Bolitho
{
  VOID Swap(LPVOID pA, LPVOID pB, SIZE_T Length);

  template<class Comparator>
  VOID Sort(LPVOID pArray, SIZE_T Count, SIZE_T ElementSize, Comparator& C);

  template<class Comparator>
  VOID Sort(LPVOID* ppArray, SIZE_T PartitionCount, SIZE_T Count, SIZE_T* ElementSize, Comparator& C);
